...
import { Plus, Download, Printer, CheckCircle, XCircle, AlertCircle, ArrowLeftRight, Zap, Trash2, Lock, Unlock } from "lucide-react";
        ...
        <DialogContent className="bg-card border-border max-w-sm">
          ...
          <p className="text-sm text-muted-foreground">
            {isLocked
              ...
              : `Fechar ${formatMonth(month)} bloqueará as abas Lançamentos e Relatório Mensal. Apenas a Visão Geral e a troca de mês continuarão funcionando.`
            }
          </p>
