...
const DESPESA_OPTIONS = [
  ...
  { value: "cartao", label: "💳 Fatura Cartão" },
  { value: "casamento", label: "💍 Casamento" },
  { value: "consorcio", label: "🔄 Consórcio" },
  { value: "energia_eletrica", label: "⚡ Energia Elétrica" },
  { value: "estudo", label: "📚 Estudo/Cursos" },
  ...
  { value: "kitnets_manutencao", label: "💧 Água/Energia Kitnets" },
  { value: "lazer", label: "🎉 Lazer" },
  { value: "maconaria", label: "🔷 Maçonaria" },
  { value: "obras", label: "🏗️ Obras" },
  { value: "plataformas_ia", label: "🤖 Plataformas de IA" },
...
const ALL_CATEGORY_LABELS: Record<string, string> = {
  ...CATEGORY_LABELS,
  academia: "Academia/Personal", alimentacao: "Alimentação", aluguel: "Aluguel",
  assinaturas: "Assinaturas", camila: "Camila", cartao: "Fatura Cartão",
  casamento: "Casamento", consorcio: "Consórcio", energia_eletrica: "Energia Elétrica",
  estudo: "Estudo/Cursos", familia: "Família", farmacia: "Farmácia",
  gas: "Gás", gasolina: "Gasolina", guarani: "Guarani",
  impostos: "Impostos/Taxas", internet: "Internet",
  kitnets_manutencao: "Água/Energia Kitnets", lazer: "Lazer",
  maconaria: "Maçonaria", obras: "Obras", plataformas_ia: "Plataformas de IA",
  saude: "Saúde", suplementos: "Suplementação", telefonia: "Telefonia",
  terapia: "Terapia", terrenos: "Terrenos", veiculo: "Veículo",
  viagens: "Viagens", outros: "Outros",
