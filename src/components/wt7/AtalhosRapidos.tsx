...
import { Briefcase, Home, FileText, Bot, BarChart3, Target, Scale } from "lucide-react";

const ATALHOS = [
  { icon: Briefcase, label: "Negócios", path: "/businesses", color: "#C9A84C" },
  ...
  { icon: Scale, label: "Jurídico", path: "/legal", color: "#FBBF24" },
];
